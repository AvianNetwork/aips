...
The AIP editors assign AIP numbers and change their status. Please send all AIP-related email to the AIP editor, which is listed under [AIP Editors](#AIP_Editors) below. Also see [AIP Editor Responsibilities & Workflow](#AIP_Editor_Responsibilities__Workflow). The AIP editor reserves the right to reject AIP proposals if they appear too unfocused or too broad.
...
## AIP Editors
The current AIP editor is Shafil who can be contacted at [alamshafil@pm.me](mailto:alamshafil@pm.me).
...
* List the AIP in [README](README.md)
