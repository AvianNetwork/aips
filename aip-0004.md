# AIP-0004: Avian Name System (ANS)
...
**However,** this will not affect the Avian mainnet since assets are not active *(as of writing)* and should not cause any hardfork/rollback once assets do go live *(given changes are merged prior)*. 
